namespace GrampsView.UserControls
{
    ...
    public partial class CollectionSingleCardHeader : Frame, INotifyPropertyChanged
    {
        public static readonly BindableProperty FsctSourceProperty
              = BindableProperty.Create(returnType: typeof(IEnumerable), declaringType: typeof(CollectionSingleCardHeader), propertyName: nameof(FsctSource)); //, propertyChanged: OnItemsSourceChanged);

        public static readonly BindableProperty FsctTemplateProperty
                    = BindableProperty.Create(nameof(FsctTemplate), returnType: typeof(DataTemplate), declaringType: typeof(CollectionSingleCardHeader), propertyChanged: OnItemTemplateChanged);
        ...
        /// </summary>
        public CollectionSingleCardHeader()
        {
            InitializeComponent();
        }
        ...
        public static void OnItemTemplateChanged(BindableObject argSource, object oldValue, object newValue)
        {
            ...
            CollectionSingleCardHeader layout = argSource as CollectionSingleCardHeader;
        ...
        /// </param>
        private void CollectionSingleCardHeaderRoot_SizeChanged(object sender, EventArgs e)
        {
            Contract.Requires(sender != null);

            CollectionSingleCardHeader t = sender as CollectionSingleCardHeader;
