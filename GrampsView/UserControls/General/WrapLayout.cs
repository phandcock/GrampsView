namespace GrampsView.UserControls
{
    ...
    public class WrapLayout : Layout<View>
    {
        ...
        public static readonly BindableProperty FsctTemplateProperty
            = BindableProperty.Create(nameof(FsctTemplate), returnType: typeof(DataTemplate), declaringType: typeof(WrapLayout));
        ...
        protected override void OnBindingContextChanged()
        {
            ...
            {
                HLinkFamilyModelCollection t = this.BindingContext as HLinkFamilyModelCollection;

                if (t != null)
                {
                    foreach (HLinkFamilyModel item in t)
                    {
                        DataTemplate tt = FsctTemplate;
                        tt.BindingContext = item;
