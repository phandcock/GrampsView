...
namespace GrampsView.Models.DataModels.Date
{
    ...
    public class DateDBModelBase : DBModelBase, IDateDBModel, IComparable
    {
        public DateDBModelBase()
        {
        }

        public DateDBModelBase(DateObjectModelBase argDate)
        {
            if (argDate.Valid)
            {
                return;
            ...
            NotionalDate = argDate.NotionalDate;

            Valid = argDate.Valid;
            ValidDay = argDate.ValidDay;
            ValidMonth = argDate.ValidMonth;
            ValidYear = argDate.ValidYear;
        }
        ...
        /// </returns>
        public static bool operator !=(DateDBModelBase left, DateDBModelBase right)
        {
            return !(left == right);
        }
        ...
        public virtual HLinkDBBase AsHLink(string v)
        {
            return new HLinkDBBase();
        }
        ...
        /// </returns>
        public int Compare(DateDBModelBase x, DateDBModelBase y)
        {
        ...
        /// </returns>
        public int CompareTo(DateDBModelBase other)
        {
        ...
        public int CompareTo(object obj)
        {
            ...
            DateDBModelBase secondEvent = (DateDBModelBase)obj;
        ...
        public override bool Equals(object obj)
        {
            ...
            DateDBModelBase? tempObj = obj as DateDBModelBase;
