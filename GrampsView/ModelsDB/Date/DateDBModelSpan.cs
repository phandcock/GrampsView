...
namespace GrampsView.Models.DataModels.Date
{
    ...
    public partial class DateDBModelSpan : DateDBModelBase, IDateDBModelSpan
    {
        /// <summary>
        /// $$(cformat)$$ field.
        /// </summary>
        ...
        public DateDBModelSpan(string aStart, string aStop, string? aCFormat = null, bool aDualDated = false, string? aNewYear = null, DateQuality aQuality = DateQuality.unknown)
        {
        ...
        ///
        [JsonIgnore]
        public HLinkDateDBModelSpan HLink
        {
            get
            {
                HLinkDateDBModelSpan t = new()
                {
                    DeRef = this,
                    HLinkKey = HLinkKey,
        ...
        public override HLinkDateDBModelSpan AsHLink(string argTitle)
        {
            HLinkDateDBModelSpan t = HLink;
            t.Title = argTitle;
