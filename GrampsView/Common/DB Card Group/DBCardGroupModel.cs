...
{
    public class DBCardGroupModel<T> : SharedSharpObservableRangeCollection<T>, INotifyCollectionChanged, INotifyPropertyChanged
          where T : DBModelBase, new()
    {
        public DBCardGroupModel()
        {
        }

        public DBCardGroupModel(IEnumerable<T> argList)
        {
