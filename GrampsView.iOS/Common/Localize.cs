...
[assembly: Xamarin.Forms.Dependency(typeof(GrampsView.iOS.Localize))]

namespace GrampsView.iOS
{
    public class ImageResource : IImageResource
    {
        Size IImageResource.GetSize(string fileName) => throw new NotImplementedException();
    }

    public class Localize : GrampsView.Common.ILocalize
    {
        ...
        {
            Thread.CurrentThread.CurrentCulture = ci ?? throw new ArgumentNullException(nameof(ci));
